...
|---|---|
| 1.0.10 automated suite / Suíte automatizada 1.0.10 | Engine, installer, update and dashboard checks run in CI; the release commit's Actions result is the source of truth / Verificações de motor, instalador, atualização e dashboard rodam no CI; o resultado do Actions para o commit da release é a fonte de verdade |
