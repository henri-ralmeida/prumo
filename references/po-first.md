...
- Verify observable results, permissions, states and relevant exceptions with checks proportional to the risk. Reuse sufficient existing tests and add checks that protect meaningful behavior.
- At completion, explain what changed, why it matters and the evidence. Distinguish implemented, verified and unverified. Never claim a test, approval or publication that did not occur. State material limitations.
