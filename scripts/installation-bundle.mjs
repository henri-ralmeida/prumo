...
export function installationBundle(lang, packageRoot = PACKAGE) {
  ...
  for (const name of ['messages.json', 'region.mjs', 'i18n.mjs', 'storage.mjs', 'atomic-state.mjs', 'validation.mjs', 'contract-drift.mjs', 'sync-plan-audit.mjs', 'dashboard-diagnostics.mjs', 'dashboard.html', 'installation-bundle.mjs', 'engine.mjs', 'serve.mjs']) files.push(join('scripts', name))
  files.push('SKILL.md')
